...
const ProductMainDetails = ({ product }: any) => {
  return (
<<<<<<< HEAD:src/app/features/products/ProductMainDetails.tsx
    <section className="relative grid grid-cols-1 lg:grid-cols-3 gap-10 items-start border-light bg-white">
=======
    <section className="relative bg-white grid grid-cols-1 lg:grid-cols-3 gap-5 above-mobile:gap-10 items-start border-light">
>>>>>>> be852de4788a8659b796c894d3cf6227a15e4683:src/ui/ProductMainDetails.tsx
