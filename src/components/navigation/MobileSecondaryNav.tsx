...
const MobileSecondaryNav: React.FC<MobileSecondaryNavProps> = ({ isLeftOpen, setIsLeftOpen }) => {
    ...
    return (
        <aside className={`block special:hidden fixed top-0 right-0 h-screen bg-white shadow-2xl z-50 transform transition-transform duration-500 ease-in-out p-6 overflow-y-auto ${isLeftOpen ? 'translate-x-0' : 'translate-x-full'}`}>
            {/* Header Title Area */}
            <div className="flex items-center justify-between pb-6 border-b border-gray-100">
                <h2 className="font-bold text-sm text-dark">Menu</h2>
            ...
            <div className="mt-6 flex flex-col gap-2">
                ...
                {MAIN_NAV.feature && (
                    <div className="border-b border-gray-50 pb-2">
                        ...
                        <div className={`overflow-hidden transition-all duration-500 ease-in-out pl-4 flex flex-col gap-2 ${openMainTabs['feature'] ? 'max-h-[1500px] opacity-100 mt-2' : 'max-h-0 opacity-0'}`}>
                ...
                {MAIN_NAV.shop && MAIN_NAV.shop.links && (
                    <div className="border-b border-gray-50 pb-2">
                        ...
                        <div className={`overflow-hidden transition-all duration-500 ease-in-out pl-4 flex flex-col gap-2 ${openMainTabs['shop'] ? 'max-h-[500px] opacity-100 mt-2' : 'max-h-0 opacity-0'}`}>
