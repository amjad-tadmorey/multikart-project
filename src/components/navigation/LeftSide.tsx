...
const LeftSide: React.FC<SideNavProps> = ({ isLeftOpen, setIsLeftOpen }) => {
    return (
        <aside className={`fixed top-0 left-0 h-screen w-50 above-mobile:w-80 bg-white shadow-md z-50 transform transition-transform duration-500 ease-in-out pl-6 pt-6 
